...
<template>
    <section class="h-full flex flex-1 justify-center gap-10 lg:p-20 items-center print:hidden text-slate-100 italic shadow-inner">
        <form class="h-full w-auto flex flex-col p-10 gap-10 items-center bg-slate-900 rounded-2xl shadow-2xl">
